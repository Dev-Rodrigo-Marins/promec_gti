...
import { Wrench, Home, Car, Search, Calendar, FileText } from "lucide-react";
...
export function Layout() {
  ...
  const navItems = [
    ...
    { path: "/cadastrar-veiculo", icon: Car, label: "Cadastrar" },
    { path: "/procurar-veiculo", icon: Search, label: "Buscar" },
        ...
        <div className="px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-100 text-xs">Gestão de Oficina</p>
            </div>
          </div>
        </div>
      </header>
